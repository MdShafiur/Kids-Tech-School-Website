...
if ($result->num_rows > 0) {
    $classs = $result->fetch_all(MYSQLI_ASSOC);
} else {
    $classs = [];
}
...
<html>
<HEAD>
<TITLE>Class Details</TITLE><link rel="shortcut icon" href="../assets/img/logo.svg" type="image/svg">
...
function closeSidebar() {
  if (sidebarOpen) {
   ...
   <div class="admin-welcome"><b>Update Class Details</b></div><br>
    ...
    $point = $class["point"];
?>
    <label for="class_name_">Product Name:</label>
    <input type="text" id="class_name_<?php echo $classId; ?>" name="class_data[<?php echo $classId; ?>][class_name]" value="<?php echo $className; ?>" required>
    <br>
    
    <label for="class_price_">Price:</label>
    <input type="number" id="class_price_<?php echo $classId; ?>" name="class_data[<?php echo $classId; ?>][class_price]" min="0" max="1000" value="<?php echo $price; ?>" required>
    <br>

    <label for="class_point_">Point:</label>
    <input type="number" id="class_point_<?php echo $classId; ?>" name="class_data[<?php echo $classId; ?>][class_point]" min="0" max="1000" value="<?php echo $point; ?>" required>
    <br>

    <label for="file_<?php echo $classId; ?>">Product Image:</label>
    <input type="file" name="file_<?php echo $classId; ?>" id="file_<?php echo $classId; ?>" >
    <br>

    <button type="submit" name="update_price_<?php echo $classId; ?>">Update Price</button>
